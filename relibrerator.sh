...
cd /mnt/us/librerator/

# bind-mount system fonts
if ! grep /mnt/us/librerator/fonts/host /proc/mounts; then
	mount -o bind /usr/java/lib/fonts /mnt/us/librerator/fonts/host
fi
...
if grep /mnt/us/librerator/fonts/host /proc/mounts; then
	umount /mnt/us/librerator/fonts/host
fi
